...
glm::vec2 Camera::WorldToScreen(const glm::vec3& worldPos, const glm::mat4& viewProj, int windowWidth, int windowHeight) {
...
glm::vec3 Camera::ScreenToWorldPoint(const glm::vec2& screenPos, float ndcZ, const glm::mat4& invViewProj, int windowWidth, int windowHeight) {
...
glm::vec3 Camera::ScreenToWorldRay(const glm::vec2& screenPos, int windowWidth, int windowHeight) const {
    float ndcX = (screenPos.x / windowWidth) * 2.0f - 1.0f;
    float ndcY = 1.0f - (screenPos.y / windowHeight) * 2.0f;
