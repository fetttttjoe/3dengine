...
Shader::Shader(const char* vertexSource, const char* fragmentSource, bool fromMemory) : m_RendererID(0) {
...
int Shader::getUniformLocation(const std::string& name) {
    ...
    if (m_RendererID == 0) {
        Log::Debug("    [getUniformLocation] FATAL: Cannot get uniform location because shader program ID is 0.");
        return -1;
    }
